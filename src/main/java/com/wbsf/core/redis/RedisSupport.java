 ...
 *            list中的操作全是按照right方式
 */
public class RedisSupport extends RedisTemplate<String, String>{
    private Logger logger = LogManager.getLogger(getClass());
    /**
     * 前缀
     */
    public static final String KEY_PREFIX_VALUE = "cache:value:";
    public static final String KEY_PREFIX_SET = "cache:set:";
    public static final String KEY_PREFIX_LIST = "cache:list:";
    ...
    protected boolean cacheSet(String k, String v, long time) {
        ...
        try {
            SetOperations<String, String> valueOps =  opsForSet();
            valueOps.add(key, v);
            if (time > 0) expire(key, time, TimeUnit.SECONDS);
            return true;
        } catch (Throwable t) {
    ...
    protected boolean cacheSet(String k, Set<String> v, long time) {
        String key = KEY_PREFIX_SET + k;
        try {
            SetOperations<String, String> setOps =  opsForSet();
    ...
    protected boolean cacheList(String k, String v, long time) {
        ...
        try {
            ListOperations<String, String> listOps =  opsForList();
