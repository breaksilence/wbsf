...
public class FileOpration extends BaseEntity {
    /**
	 * 
	 */
     ...
     * 获取散列目录，也可以作为文件分组使用
     *
     * @return group_folder - 散列目录，也可以作为文件分组使用
     */
     ...
     * 设置散列目录，也可以作为文件分组使用
     *
     * @param groupFolder 散列目录，也可以作为文件分组使用
     */
    public void setGroupFolder(String groupFolder) {
        this.groupFolder = groupFolder == null ? null : groupFolder.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", groupFolder=").append(groupFolder);
