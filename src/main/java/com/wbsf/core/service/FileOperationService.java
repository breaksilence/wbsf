 ...
 *
 */
public interface FileOperationService extends BaseService<FileOperation> {
	 ...
	 *             抛出文件保存时发生的IO异常
	 */
	Result<List<FileOperation>> storage(String relativeStoragePath, MultipartFile... multipartFiles);
	 ...
	 */
	Result<List<FileOperation>> saveFile(String relativeStoragePath, Date expiredDate, MultipartFile... multipartFiles);
	 ...
	 * @return 返回删除的文件信息列表
	 */
	Result<List<FileOperation>> deleteFile(FileOperation... deleteFiles);
	 ...
	 */
	Result<List<FileOperation>> queryFile(FileOperation... queryFiles);
}
